...
use crate::types::AdditionalContextToml;
...
pub struct ConfigToml {
    ...
    /// Proxy for all of Codex's outbound HTTP and WebSocket traffic: `http://`, `https://`,
    /// `socks5://` or `socks5h://` (credentials may be embedded). Takes precedence over
    ...
    pub additional_context: Option<AdditionalContextToml>,
